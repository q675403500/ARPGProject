...
public static class LuaBinder
{
	public static void Bind(LuaState L)
	{
		...
		LuaFramework_UtilManagerWrap.Register(L);
		L.EndModule();
		...
		L.RegFunction("Action_SocketIO_SocketIOEvent", System_Action_SocketIO_SocketIOEvent);
		L.RegFunction("Action_JSONObject", System_Action_JSONObject);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int System_Action_SocketIO_SocketIOEvent(IntPtr L)
	{
		try
		{
			int count = LuaDLL.lua_gettop(L);
			...
			if (count == 1)
			{
				Delegate arg1 = DelegateTraits<System.Action<SocketIO.SocketIOEvent>>.Create(func);
				ToLua.Push(L, arg1);
			}
			else
			{
				LuaTable self = ToLua.CheckLuaTable(L, 2);
				Delegate arg1 = DelegateTraits<System.Action<SocketIO.SocketIOEvent>>.Create(func, self);
				ToLua.Push(L, arg1);
			}
			return 1;
		}
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int System_Action_JSONObject(IntPtr L)
	{
		try
		{
			int count = LuaDLL.lua_gettop(L);
			...
			if (count == 1)
			{
				Delegate arg1 = DelegateTraits<System.Action<JSONObject>>.Create(func);
				ToLua.Push(L, arg1);
			}
			else
			{
				LuaTable self = ToLua.CheckLuaTable(L, 2);
				Delegate arg1 = DelegateTraits<System.Action<JSONObject>>.Create(func, self);
				ToLua.Push(L, arg1);
			}
			return 1;
		}
