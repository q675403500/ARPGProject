...
public class DelegateFactory
{
	...
	public static void Register()
	{
		...
		dict.Add(typeof(System.Action<SocketIO.SocketIOEvent>), factory.System_Action_SocketIO_SocketIOEvent);
		dict.Add(typeof(System.Action<JSONObject>), factory.System_Action_JSONObject);
		...
		DelegateTraits<System.Action<SocketIO.SocketIOEvent>>.Init(factory.System_Action_SocketIO_SocketIOEvent);
		DelegateTraits<System.Action<JSONObject>>.Init(factory.System_Action_JSONObject);
		...
		TypeTraits<System.Action<SocketIO.SocketIOEvent>>.Init(factory.Check_System_Action_SocketIO_SocketIOEvent);
		TypeTraits<System.Action<JSONObject>>.Init(factory.Check_System_Action_JSONObject);
		...
		StackTraits<System.Action<SocketIO.SocketIOEvent>>.Push = factory.Push_System_Action_SocketIO_SocketIOEvent;
		StackTraits<System.Action<JSONObject>>.Push = factory.Push_System_Action_JSONObject;
	...
	class System_Action_SocketIO_SocketIOEvent_Event : LuaDelegate
	{
		public System_Action_SocketIO_SocketIOEvent_Event(LuaFunction func) : base(func) { }
		public System_Action_SocketIO_SocketIOEvent_Event(LuaFunction func, LuaTable self) : base(func, self) { }

		public void Call(SocketIO.SocketIOEvent param0)
		{
			func.BeginPCall();
			func.PushObject(param0);
			func.PCall();
		...
		public void CallWithSelf(SocketIO.SocketIOEvent param0)
		{
			func.BeginPCall();
			func.Push(self);
			func.PushObject(param0);
	...
	public System.Action<SocketIO.SocketIOEvent> System_Action_SocketIO_SocketIOEvent(LuaFunction func, LuaTable self, bool flag)
	{
		if (func == null)
		{
			System.Action<SocketIO.SocketIOEvent> fn = delegate(SocketIO.SocketIOEvent param0) { };
			return fn;
		}

		if(!flag)
		{
			System_Action_SocketIO_SocketIOEvent_Event target = new System_Action_SocketIO_SocketIOEvent_Event(func);
			System.Action<SocketIO.SocketIOEvent> d = target.Call;
			target.method = d.Method;
			return d;
		}
		else
		{
			System_Action_SocketIO_SocketIOEvent_Event target = new System_Action_SocketIO_SocketIOEvent_Event(func, self);
			System.Action<SocketIO.SocketIOEvent> d = target.CallWithSelf;
			target.method = d.Method;
			return d;
		}
	}

	bool Check_System_Action_SocketIO_SocketIOEvent(IntPtr L, int pos)
	{
		return TypeChecker.CheckDelegateType(typeof(System.Action<SocketIO.SocketIOEvent>), L, pos);
	}

	void Push_System_Action_SocketIO_SocketIOEvent(IntPtr L, System.Action<SocketIO.SocketIOEvent> o)
	{
		ToLua.Push(L, o);
	}

	class System_Action_JSONObject_Event : LuaDelegate
	{
		public System_Action_JSONObject_Event(LuaFunction func) : base(func) { }
		public System_Action_JSONObject_Event(LuaFunction func, LuaTable self) : base(func, self) { }

		public void Call(JSONObject param0)
		{
			func.BeginPCall();
			func.PushObject(param0);
			func.PCall();
		...
		public void CallWithSelf(JSONObject param0)
		{
			func.BeginPCall();
			func.Push(self);
			func.PushObject(param0);
	...
	public System.Action<JSONObject> System_Action_JSONObject(LuaFunction func, LuaTable self, bool flag)
	{
		if (func == null)
		{
			System.Action<JSONObject> fn = delegate(JSONObject param0) { };
			return fn;
		}

		if(!flag)
		{
			System_Action_JSONObject_Event target = new System_Action_JSONObject_Event(func);
			System.Action<JSONObject> d = target.Call;
			target.method = d.Method;
			return d;
		}
		else
		{
			System_Action_JSONObject_Event target = new System_Action_JSONObject_Event(func, self);
			System.Action<JSONObject> d = target.CallWithSelf;
			target.method = d.Method;
			return d;
		}
	}

	bool Check_System_Action_JSONObject(IntPtr L, int pos)
	{
		return TypeChecker.CheckDelegateType(typeof(System.Action<JSONObject>), L, pos);
	}

	void Push_System_Action_JSONObject(IntPtr L, System.Action<JSONObject> o)
	{
		ToLua.Push(L, o);
	}
