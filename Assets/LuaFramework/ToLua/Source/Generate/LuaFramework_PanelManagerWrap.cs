...
public class LuaFramework_PanelManagerWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("CreatePrefabPanel", CreatePrefabPanel);
	...
	static int CreatePrefabPanel(IntPtr L)
	{
		try
		{
			...
			if (count == 3)
			{
				...
				obj.CreatePrefabPanel(arg0, arg1);
				return 0;
			}
			else if (count == 4)
			{
				...
				obj.CreatePrefabPanel(arg0, arg1, arg2);
				return 0;
			}
			else
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: LuaFramework.PanelManager.CreatePrefabPanel");
			}
		}
		catch (Exception e)
		{
